...
key_aliyun_key_id = None
key_aliyun_key_secret = None
key_aliyun_app_key = None
key_ms_tts_key = None
...
def load_config():
    ...
    global key_aliyun_key_id
    global key_aliyun_key_secret
    global key_aliyun_app_key
    ...
    key_aliyun_key_id = system_config.get('key', 'aliyun_key_id')
    key_aliyun_key_secret = system_config.get('key', 'aliyun_key_secret')
    key_aliyun_app_key = system_config.get('key', 'aliyun_app_key')
